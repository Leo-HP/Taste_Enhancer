...
public class CreateIngredient {
    ...
    public CreateIngredient(String name, List<CategoryDto> categoryDtoList, List<OriginDto> originDtoList, List<SeasonDto> seasonDtoList, List<TasteDto> tasteDtoList) {
        this.name = name;
